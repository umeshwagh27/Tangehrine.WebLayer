...
namespace Tangehrine.WebLayer.Common
{
    public static class CommonMethod
    {
        //public static string GetUserGroupName(string roleName)
        //{
        //    switch (roleName)
        //    {
        //        case UserRoles.SystemSuperAdmin:
        //            return UserRoleGroup.Admin;
        //        case UserRoles.FinanceManager:
        //            return UserRoleGroup.Admin;
        //        case UserRoles.DataManager:
        //            return UserRoleGroup.Admin;
        //        case UserRoles.CustomerSupportForDistributor:
        //            return UserRoleGroup.Admin;
        //        case UserRoles.CustomerSupportForPharmacy:
        //            return UserRoleGroup.Admin;
        //        case UserRoles.DistributorPrimaryAdmin:
        //            return UserRoleGroup.Distributor;
        //        case UserRoles.DistributorAdmin:
        //            return UserRoleGroup.Distributor;
        //        case UserRoles.DistributorStaff:
        //            return UserRoleGroup.Distributor;
        //        case UserRoles.PharmacyPrimaryAdmin:
        //            return UserRoleGroup.Pharmacy;
        //        case UserRoles.PharmacyAdmin:
        //            return UserRoleGroup.Pharmacy;
        //        case UserRoles.PharmacyStaff:
        //            return UserRoleGroup.Pharmacy;
        //        case UserRoles.Developer:
        //            return UserRoleGroup.Developer;
        //        default:
        //            return UserRoleGroup.Admin;
        //    }
        //}

        //public static string GetDisplayUserRole(string roleName)
        //{
        //    switch (roleName)
        //    {
        //        case UserRoles.SystemSuperAdmin:
        //            return UserRoleForDisplay.SystemSuperAdmin;
        //        case UserRoles.SystemAdmin:
        //            return UserRoleForDisplay.SystemAdmin;
        //        case UserRoles.FinanceManager:
        //            return UserRoleForDisplay.FinanceManager;
        //        case UserRoles.DataManager:
        //            return UserRoleForDisplay.DataManager;
        //        case UserRoles.CustomerSupportForDistributor:
        //            return UserRoleForDisplay.CustomerSupportForDistributor;
        //        case UserRoles.CustomerSupportForPharmacy:
        //            return UserRoleForDisplay.CustomerSupportForPharmacy;
        //        case UserRoles.DistributorPrimaryAdmin:
        //            return UserRoleForDisplay.DistributorPrimaryAdmin;
        //        case UserRoles.DistributorAdmin:
        //            return UserRoleForDisplay.DistributorAdmin;
        //        case UserRoles.DistributorStaff:
        //            return UserRoleForDisplay.DistributorStaff;
        //        case UserRoles.PharmacyPrimaryAdmin:
        //            return UserRoleForDisplay.PharmacyPrimaryAdmin;
        //        case UserRoles.PharmacyAdmin:
        //            return UserRoleForDisplay.PharmacyAdmin;
        //        case UserRoles.PharmacyStaff:
        //            return UserRoleForDisplay.PharmacyStaff;
        //        case UserRoles.Developer:
        //            return UserRoleForDisplay.Developer;
        //        default:
        //            return UserRoleForDisplay.SystemSuperAdmin;
        //    }
        //}
        ...
        /// <summary>
        /// Convert Html string to Pdf file and Returns the byte array fo resulted pdf file , Using Rotativa
        /// </summary>
        /// <param name="rootPath">Absolute Path of Roatative wkhtmltopdf.exe</param>
        /// <param name="template">Html string</param>
        /// <param name="switches">Common setting of rotativa</param>
        /// <param name="header">Header template for Pdf File</param>
        /// <param name="footer">Footer template fro Pdf File</param>
        /// <returns>Returns the byte array of Pdf file from Html string</returns>
        //public static byte[] ConvertHtmlToPdf(string rootPath, string template, string switches = "--page-offset 0 --footer-center [page] --footer-font-size 12", string header = null, string footer = null)
        //{
        //    if (header != null && footer != null)
        //    {
        //        switches = $"--page-size Letter --header-html \"{header}\" " + "--header-spacing \"5\" " + $"--footer-html \"{footer}\" " +
        //                   "--footer-spacing \"5\" " + "--footer-font-size \"10\" " + "--header-font-size \"10\" ";

        //    }
        //    return Rotativa.AspNetCore.WkhtmltopdfDriver.ConvertHtml(rootPath + @"\Rotativa\", switches, template);
        //}
        ...
        public static string ReadEmailTemplate(IErrorLogService logService, string currentPath, string template, string physicalUrl)
        {
            try
            {
                string fullPath = CheckServerPath(currentPath,EmailTemplateList.EmailTemplate, template);
                string body;
        ...
        public static JQueryDataTableSqlParam GetJQueryDatatableParamListPatient(JQueryDataTableParamModel param, string sortingColumn,long id)
        {
            var searchRecords = new SqlParameter { ParameterName = "@SearchRecords", SqlDbType = SqlDbType.Int, Direction = ParameterDirection.Output };
            ...
            var parameters = new JQueryDataTableSqlParam()
            {
                ...
                Parameters = new List<SqlParameter>
                {
                    ...
                    new SqlParameter("@SortDir",SqlDbType.VarChar){Value = param.sSortDir_0 ?? ""},
                    new SqlParameter("@Search",SqlDbType.NVarChar){Value = param.sSearch ?? ""},
                   new SqlParameter("@Pid",SqlDbType.Int){Value = id},
                    searchRecords
                }
            };
        ...
        //public static RewardEarnDto NewRewardEarnDto(long rewardTypeId, long? pharmacyId = null, long? orderId = null)
        //{
        //    return new RewardEarnDto { RewardTypeId = rewardTypeId, PharmacyId = pharmacyId, OrderId = orderId };
        //}
        #endregion
    }
}
